...
dim(testingData)
```
A visual inspection of the data in Excel shows a lot of missing data (NA or empty string). I won't use columns with NAs as predictors.  I will use the exercise variables (belt, arm, dumbbell, and forearm variables) that have complete data as the predictors for the classe variable.
